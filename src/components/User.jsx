...
export default function User() {
  ...
  return (
    <div className="p-10 bg-gradient-to-br from-blue-100 via-white to-blue-200 min-h-screen">
      ...
      <form
        ...
        className="bg-white shadow-xl rounded-lg p-6 max-w-lg mx-auto mb-10 border border-gray-200"
      >
        <h2 className="text-2xl font-semibold mb-5 text-gray-800">
          {editingId ? "Update" : "Create"}
        </h2>
        <div className="mb-4">
          <label className="block text-gray-600 mb-2 font-medium">Ism</label>
          <input
            type="text"
            placeholder="name"
            value={form.name}
        ...
        <div className="mb-4">
          <label className="block text-gray-600 mb-2 font-medium">Manzil</label>
          <input
            type="text"
            placeholder="address"
            value={form.address}
